...
<section class="vd-report-page" id="reportPage">
    ...
    <div class="vd-report-print-footer">
        <span>Confidential &mdash; authorized clinic use only</span>
        <span>Generated by <?= reportEscape($_SESSION['display_name'] ?? $_SESSION['email'] ?? 'Administrator') ?> on <?= date('M j, Y g:i A') ?></span>
    </div>
</section>
