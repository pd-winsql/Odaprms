...
odontogramExpect(str_contains($editable, '>Teeth displayed</span>') && str_contains($editable, 'aria-labelledby="editableChartDentitionLabel"'), 'Teeth displayed is a separate label for the segmented control.');
